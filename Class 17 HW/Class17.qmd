---
title: "Class 17 HW Plot"
author: "Destiny (A16340362)"
format: pdf
---
```{r}
b<-read.csv("~/Documents/BIMM 143/Class 17 HW/mm-second.x.zebrafish.tsv", sep="\t", col.names=c("qseqid", "sseqid", "pident", "length", "mismatch", "gapopen", "qstart", "qend", "sstart", "send", "evalue", "bitscore"))
```
